...
const FAQ_AR = [
  ...
  { icon: "⚡", title: "شو هي نقاط XP وكيف بجمعها؟", desc: "كل 1 دينار من قيمة الطلب = 100 XP. النقاط بترفع مستواك، وكل مستوى بيفتح لك مكافأة عملات أعلى وأفاتارات وكوبونات خاصة بالمستوى." },
  { icon: "🪙", title: "شو هي GX Coins وكيف بحصل عليها؟", desc: "كل 1 دينار بتدفعه فعلياً = 10 GX Coins مضروبة بمكافأة مستواك. كمان بتحصل على عملات من عجلة الحظ ومن جوائز البطولات." },
  { icon: "🧮", title: "كيف بستخدم GX Coins؟", desc: "كل 1000 عملة = 1 دينار خصم، والعملات بتغطي حتى 50% من قيمة الطلب. بتختار عدد العملات الي بدك تستخدمها عند إتمام الطلب." },
  ...
  { icon: "🎫", title: "شو الفرق بين رصيد المتجر و GX Coins؟", desc: "رصيد المتجر هو رصيد حقيقي بعملتك (من استرجاع أو إضافة من الإدارة) وبيغطي كامل الطلب. أما GX Coins فهي عملة مكافآت بحد أقصى 50% من الطلب. الاثنين خاصين فيك وما بيشوفهم غيرك، بيظهروا بس داخل ملفك الشخصي." },
